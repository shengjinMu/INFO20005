...
// Search
const allProducts = [
  { name: 'Distressed Denim Vest', price: '$68.00', page: 'denim.html' },
  ...
  { name: 'Classic Knit Jumper', price: '$55.00', page: 'jumper.html' },
  { name: 'Striped Cotton Jumper', price: '$58.00', page: 'jumper.html' },
  { name: 'Wool Blend Jumper', price: '$65.00', page: 'jumper.html' },
  { name: 'Cable Knit Jumper', price: '$62.00', page: 'jumper.html' },
  { name: 'Ribbed Turtleneck Jumper', price: '$60.00', page: 'jumper.html' },
  { name: 'Bow Collar Natural', price: '$75.00', page: 'walk.html' },
  { name: 'Bow Collar Black', price: '$75.00', page: 'walk.html' },
  { name: 'Lead Navy', price: '$80.00', page: 'lead.html' },
  { name: 'Lead Black', price: '$80.00', page: 'lead.html' },
  { name: 'Lead Blue', price: '$80.00', page: 'lead.html' },
  { name: 'Lead Red', price: '$80.00', page: 'lead.html' },
  { name: 'Lead Tortoiseshell', price: '$70.00', page: 'lead.html' },
  { name: 'Lead Pink', price: '$80.00', page: 'lead.html' },
  { name: 'Plaid Pet Blanket', price: '$89.00', page: 'blanket.html' },
  { name: 'Ceramic Pet Bowl', price: '$28.00', page: 'home.html' },
